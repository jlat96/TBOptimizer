...
namespace TrailBlazer.TBOptimizer.Configuration
{
        ...
        where TEvaluation : IComparable<TEvaluation>
    {
        ...
        public IHillClimber<TState, TEvaluation> Build()
        {
            ...
            {
                ClimberSuccessorSelector<TState, TEvaluation> successorSelector = new ClimberSuccessorSelector<TState, TEvaluation>(StateComparer, SuccessorGenerationFunction);
        ...
        {
            return (StateComparer != null && SuccessorGenerationFunction != null);
        }
    }
}
