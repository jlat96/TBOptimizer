...
namespace TrailBlazer.TBOptimizer.Climber.Algorithm
{
        ...
        where TEvaluation : IComparable<TEvaluation>
    {
        ...
        private readonly IComparer<TState> stateComparer;
        ...
        public ClimberSuccessorSelector(IComparer<TState> evaluationComparer, Func<TState, IEnumerable<TState>> successorGenerationFunction)
        {
            this.stateComparer = evaluationComparer;
        ...
        {
            TState bestSuccessor = successorGenerationFunction.Invoke(current).Extrema<TState, TEvaluation>(stateComparer);
            ...
            if (stateComparer.Compare(current, bestSuccessor) <= 0 ||
                stateEncountered)
            {
                return current;
            }
