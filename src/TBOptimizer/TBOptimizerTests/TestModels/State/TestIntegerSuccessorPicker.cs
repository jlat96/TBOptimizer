...
namespace OptimizerTests.TestModels.State
{
    public class TestIntegerSuccessorPicker: ISuccessorSelector<TestIntegerEvaluableState, int>
    {
        ...
        private readonly IComparer<TestIntegerEvaluableState> comparer;
        ...
        {
            TestIntegerEvaluableState next = MakeNeighbors(current).Extrema<TestIntegerEvaluableState, int>(comparer);
